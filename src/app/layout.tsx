...
import { initPerformanceMonitoring, initErrorTracking } from '@/lib/monitoring';
...
export const metadata: Metadata = {
  title: 'Cultural E-commerce Platform',
  description: 'Handcrafted Treasures, Rooted in Culture',
}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                      ...
                      <ul className="space-y-2">
                        ...
                        <li><a href="/size-guide" className="hover:text-gray-300">Size Guide</a></li>
                      </ul>
                    </div>
                    ...
                    <div>
                      ...
                      <ul className="space-y-2">
                        ...
                        <li><a href="/accessibility" className="hover:text-gray-300">Accessibility</a></li>
                      </ul>
                    </div>
                    ...
                    <div>
                      ...
                      <form className="space-y-2">
                        <input
                          ...
                          className="w-full px-4 py-2 rounded-full bg-gray-800 text-white border border-gray-700 focus:outline-none focus:border-white"
                        />
                        <button
                          type="submit"
                          className="w-full bg-white text-black px-4 py-2 rounded-full font-medium hover:bg-gray-100"
                        >
                          Subscribe
                        </button>
                      </form>
